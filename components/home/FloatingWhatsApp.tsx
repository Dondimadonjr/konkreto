export default function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-lg border border-white/10 bg-[#0e0e0e]/95 px-3 py-2 text-xs font-medium text-white opacity-0 shadow-lg backdrop-blur-md transition duration-200 group-hover:opacity-100">
